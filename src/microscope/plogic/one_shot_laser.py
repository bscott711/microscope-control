...
class AcquisitionGUI:
    ...
    def create_widgets(self):
        ...
        ttk.Label(vol_frame, text="Laser Duration (ms)").grid(row=1, column=0, sticky="w", padx=5)
        ttk.Entry(vol_frame, textvariable=self.laser_duration_var).grid(row=1, column=1, sticky="ew", padx=5)
